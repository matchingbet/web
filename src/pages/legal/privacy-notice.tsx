        ...
        <ThemeProvider theme={theme}>
            ...
            <StyledContainer>
                ...
                <p>
                    ...
                    do matching.bet respeitar a sua privacidade em relação a qualquer informação sua que possamos
                    coletar no
                    site <Link href="/">matching.bet</Link>, e outros sites que possuímos e operamos.
                </p>
                <p>
                    Solicitamos
                    informações pessoais apenas quando realmente precisamos delas para lhe fornecer um serviço.
                    Fazemo-lo
                ...
                <p>
                    ...
                    tempo necessário para fornecer o serviço solicitado. Quando armazenamos dados, protegemos dentro de
                    meios comercialmente aceitáveis ​​para evitar perdas e roubos, bem como acesso, divulgação, cópia,
                    uso
                ...
                <p>
                    ...
                    por suas respectivas <Link href='https://politicaprivacidade.com' target='_BLANK'>políticas de
                    privacidade</Link>.
                </p>
                <p>
                    Você é livre para recusar a nossa solicitação de
                    informações pessoais, entendendo que talvez não possamos fornecer alguns dos serviços desejados.
                </p>
                <p>
                    O
                    uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de <Link
                    href='https://avisodeprivacidad.info/' target='_BLANK'
                    style={{color: "inherit !important", textDecoration: "none !important"}}>Aviso de
                    Privacidad</Link> e
                ...
                <h2>Política de Cookies matching.bet</h2>
                <h3>O que são cookies?</h3>
                <p>
                    Como é prática comum em quase todos os sites
                    profissionais, este site usa cookies, que são pequenos arquivos baixados no seu computador, para
                    melhorar sua experiência. Esta página descreve quais informações eles coletam, como as usamos e por
                    que
                    às vezes precisamos armazenar esses cookies. Também compartilharemos como você pode impedir que
                    esses
                    cookies sejam armazenados, no entanto, isso pode fazer o downgrade ou &apos;quebrar&apos; certos
                    elementos da
                    funcionalidade do site.
                </p>
                <h3>Como usamos os cookies?</h3>
                <p>Utilizamos cookies por
                    vários motivos, detalhados abaixo. Infelizmente, na maioria dos casos, não existem opções padrão do
                    setor para desativar os cookies sem desativar completamente a funcionalidade e os recursos que eles
                ...
                <h3>Desativar cookies</h3>                    <p>Você pode impedir a configuração de cookies ajustando
                as configurações do seu navegador (consulte a Ajuda do navegador para saber como fazer isso). Esteja
                ciente de que a desativação de cookies afetará a funcionalidade deste e de muitos outros sites que você
                visita. A desativação de cookies geralmente resultará na desativação de determinadas funcionalidades e
                recursos deste site. Portanto, é recomendável que você não desative os cookies.</p>
                ...
                <ul>
                    ...
                    <li> Pedidos processando cookies relacionados
                        <br/>
                        <br/>
                        Este site oferece facilidades de comércio
                    ...
                    <li> Cookies relacionados a formulários
                        ...
                        ser configurados para lembrar os detalhes do usuário para correspondência futura.
                        <br/>
                        <br/>
                    </li>
                ...
                <p>
                    ...
                    fornecidos por terceiros confiáveis. A seção a seguir detalha quais cookies de terceiros você pode
                ...
                <p>O usuário se compromete a fazer uso
                    adequado dos conteúdos e da informação que o matching.bet oferece no site e com caráter enunciativo,
                    mas
                    não limitativo:</p>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <a
                            style={{color: "inherit !important", textDecoration: "none !important"}}
                    ...
                    <li>
                        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do matching.bet, de
                ...
                <p>
                    Esta política é efetiva a partir de <strong>July</strong>/<strong>2022</strong>.
                </p>
            </StyledContainer>
        </ThemeProvider>
    );
